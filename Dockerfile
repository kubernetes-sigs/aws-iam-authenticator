...
ARG golang_image=public.ecr.aws/eks-distro-build-tooling/golang:1.26.3
...
FROM --platform=$TARGETPLATFORM public.ecr.aws/eks-distro-build-tooling/go-runner:v0.18.0-go-1.26.3.2023 AS go-runner

...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.46.0 // indirect; https://github.com/advisories/GHSA-8pgv-569h-w5rw
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.44.0 // indirect; https://github.com/advisories/GHSA-rcjv-mgp8-qvmr

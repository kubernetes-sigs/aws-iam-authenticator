...
From the base directory, run `make e2e RUNNER=kops`. Alternatively, run `GINKGO_FOCUS="[<test_group>]" ./hack/e2e/run.sh` to run a specific subset of tests.
...
- `K8S_VERSION`: Kubernetes version. This must be compatible with the specified `KOPS_VERSION`, and vice versa.
